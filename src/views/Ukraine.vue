<template>
    <div class="uk" name="uk">
        <link
            rel="stylesheet"
            href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css"
        />
        <div class="animate__animated container1" 
...
export default{
    ...
    methods:{
        NewsUSA(){
            this.axios.get("https://newsapi.org/v2/top-headlines?country=ua&apiKey=d7f41a32c26b4bbfb596d58b1a54c766")
            .then( (response)=>{
